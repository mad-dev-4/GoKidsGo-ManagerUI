...
@Component({
  selector: 'app-find-seasonal-tag-modal',
  templateUrl: './find-seasonal-tag-modal.page.html',
  styleUrls: ['./find-seasonal-tag-modal.page.scss'],
})
export class FindSeasonalTagModalPage implements OnInit {
  private _className = 'FindSeasonalTagModalPage';
